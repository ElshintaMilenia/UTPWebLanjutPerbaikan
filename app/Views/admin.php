    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Elshinta Collection Admin</div>
            </a>
            ...
            <div class="sidebar-card">
                ...
                <p class="text-center mb-2"><strong>Elshinta Collection</strong> is packed with premium features, components, and more!</p>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">ElshintaMilenia</span>
                                <img class="img-profile rounded-circle" src="<?= base_url('assets'); ?>/2.jpeg">
                            </a>
